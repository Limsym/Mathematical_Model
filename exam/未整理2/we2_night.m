...
figure
plot( t(1:746),pT(1:746),'r' );hold on;grid on
plot( t(39:746), T(39:746),'b' );hold on
...
nihedu=1-PCL
k_better
save ('datas.mat','k_better','Ta'); %表示将内存变量data, x, y, z 保存到当前路径下的datas.mat文件，其它程序若要载入这几个变量的数据，只需前面路径下执行
load datas;
%%
