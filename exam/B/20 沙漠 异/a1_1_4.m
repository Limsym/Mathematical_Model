...
l5=3;%村庄到终点距离
l6=5;%矿山到终点距离
T1=l1;T2=l2;T3=l3;T4=l4;T5=l5;T6=l6;T61=l6;T41=l4;
...
wz=sum(w1);
fz=sum(f1);
if fix((M-fz*2)/3)>=sum(w1(T2+1:j+T4))
    bf0=fz;
    bf1=0;
    bf2=0;
    bw0=fix((M-bf0*2)/3);
    bw1=wz-bw0-bw2;
    bw2=sum(w1(j+T4+1:Td));
else
    bf0=fix((M-sum(w1(T2+1:j+T4))*3)/2)+sum(f1(1:T2));
    bf1=0;
    bf2=fz-bf0;
    bw0=fix((M-bf0*2)/3);
    bw1=sum(w1(T2+1:j+T4))-(bw0-sum(w1(1:T2)));
    bw2=wz-bw0-bw1;
end
