...
minpc=inf;
for alpha=20.8:0.0001:20.9
    for beta=4.1:0.0001:4.15
...
sure=1;if sure==1 save('r2_1','A','B');end
% for i=1:n1-1
...
R=1-sqrt(Q./X);
figure;plot(tr1,Vr1,'linewidth',6.5),hold on,plot([tr1],[BV1(1:n1)],'r','linewidth',2.5);
plot(tr2,Vr2,'linewidth',6.5),hold on,plot([tr2],[BV2(1:n2)],'r','linewidth',2.5);
